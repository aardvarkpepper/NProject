...
/*
Need some sort of validation so people can't just do whatever.
Check if premium account (database costs to run).
Log queries so can see user activity (including time);
...
//bootlegcode
// const getBookmarkReviews = async (id) => {
//   try {
//     const bookmarkReviews = await db.any("SELECT * FROM reviews WHERE bookmark_id=$1", id);
//     return bookmarksReviews;
//   } catch (error) {
//     return error;
//   }
// };
